...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                @if(isset($edit))
                {!! Form::open(['route' => 'updateUmatAdmin', 'method' => 'post', 'files' => 'true', 'role' => 'form']) !!}
                @else
                {!! Form::open(['route' => 'simpanUmat', 'method' => 'post', 'files' => 'true', 'role' => 'form']) !!}
                @endif
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(document.getElementById('lingkungan')).change(function(){
                var v = $(this).val();
                alert("{{ Session::token() }} | " + $(document.getElementsByName('_token')).val());
                getKeluarga(v);
            });
        });
        ...
        function getKeluarga(id){
            ...
            $.ajax({
                type: "post",
                url: "{!! url(route('updateKeluargaAjax')) !!}",
                data:{'idLing':$(document.getElementById('lingkungan')).val(), '_token': $(document.getElementsByName('_token')).val()},
                success:function(kk){
                    alert(kk);
//                    $(document.getElementById('namakk')).html(data);
                }
            });
        }
    </script>
