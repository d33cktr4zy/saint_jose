...
@section('content')
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="judul" placeholder="Judul Pengumuman" name="judul" value="{!! $data->tema_pengumuman !!}">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $('#tanggal').datetimepicker({
                                locale: 'id',
                                format: "DD-MM-YYYY",
                                defaultDate: "{!! $data->tgl_pengumuman !!}",
                            });
                        });
                    </script>
                </div>
                    ...
                    <div class="form-group form-inline" style="display: block;">
                        ...
                        <select id="jenis" class="form-control" name="jenis">
                            ...
                            @foreach($jenis as $jPeng)
                                @if($data->id_jns_pengumuman == $jPeng->id_jns_pengumuman)
                                    <option value="{!! $jPeng->id_jns_pengumuman !!}" selected>{!! $jPeng->jns_pengumuman !!}</option>
                                @else
        ...
        <div class="row">
            <div class="col-xs-12">
                <textarea class="form-control input-lg" rows="12" name="isi">{!! $data->isi_pengumuman !!}
                </textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger left">Batal</button>
                    </div>
                    <div class="btn-group">
                        <button type="submit" class="btn btn-success right">Kirim</button>
                    </div>
                </div>
            </div>
        </div>
